package com.example.applicatonmap;
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng petogogan = new LatLng(-6.226406, 107.017761);
        mMap.addMarker(new MarkerOptions().position(petogogan).title("Jl. Ebony Raya no.194"));
